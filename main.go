...
func main() {
	...
	sphere := &geometry.Sphere{SpecularFactor: 10, Color: vector.CreateColor(1.0, 0.0, 0.0), Radius: 0.2, Center: &vector.Vector{X: 0.0, Y: 0.0, Z: -2.0, W: 0}}
	pointOfLight := &light.PointOfLight{Point: &vector.Vector{X: 0.0, Y: 2.0, Z: -2.0, W: 0.0}, Intensity: 0.6}
	flag.Parse()
